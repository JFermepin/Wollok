...
object juego {
	...
	var property itemNivelUno = new ItemMenu(imagen = "nivel1.png", posicion = game.at(7, 8), proximo = new Nivel(dificultad = 1, objetivo = 20, escenario = "Bosque", musicaFondoJuego = new Sound(file = "ambienteBosque.mp3")))
	var property itemNivelDos = new ItemMenu(imagen = "nivel2.png", posicion = game.at(16, 8), proximo = new Nivel(dificultad = 2, objetivo = 25, escenario = "Desierto", musicaFondoJuego = new Sound(file = "ambienteDesierto.mp3")))
	var property itemNivelTres = new ItemMenu(imagen = "nivel3.png", posicion = game.at(7, 2), proximo = new Nivel(dificultad = 3, objetivo = 35, escenario = "Nieve", musicaFondoJuego = new Sound(file = "ambienteNieve.mp3")))
	var property itemNivelCuatro = new ItemMenu(imagen = "nivel4.png", posicion = game.at(16, 2), proximo = new Nivel(dificultad = 4, objetivo = 40, escenario = "Infierno", musicaFondoJuego = new Sound(file = "ambienteInfierno.mp3")))
